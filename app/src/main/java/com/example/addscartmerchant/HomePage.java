...
//
//        LocalDateTime datetime = LocalDateTime.parse("2022-03-14", oldPattern);
...
//                                    Latitude.add(data);
//                                }
//                                obj.setUserLat(Latitude.get(finalI));
//                            }
//
//                            @Override
//                            public void onCancelled(@NonNull DatabaseError error) {
...
//                                    Longitude.add(data);
//                                }
//                                obj.setUserLon(Longitude.get(finalI));
//                            }
//
//                            @Override
//                            public void onCancelled(@NonNull DatabaseError error) {
...
//                                    ItemType.add(data);
//                                }
//                                obj.setUserItems(ItemType.get(finalI));
//                            }
//
//                            @Override
//                            public void onCancelled(@NonNull DatabaseError error) {
...
//                        System.out.println(obj.getUserPhoneNo());
                    }
                    else{
                        if(y2==y1){
                            if(m2==m1){
...
//                                    @Override
//                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
//                                        name.add((String) snapshot.getValue());
//
////                                        DatabaseReference putname = fdata.getReference("TodayPickup").child(PhoneNumber.get(finalI));
////                                        putname.child("name").setValue((String)snapshot.getValue());
//
...
//
////                                                                is complete
//                                                                DatabaseReference refiscomp = fdata.getReference("OrderId").child("IsComplete");
//                                                                refiscomp.addValueEventListener(new ValueEventListener() {
//                                                                    @Override
//                                                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
//                                                                        for(DataSnapshot dataSnapshot : snapshot.getChildren()){
//                                                                            String data = dataSnapshot.getValue(String.class);
...
//                                                                        }
//                                                                        DatabaseReference putdata = fdata.getReference("TodayPickup").child(PhoneNumber.get(finalI));
//                                                                        if(iscomplete.get(finalI).equals("False")) {
//                                                                            putdata.child("latitude").setValue(Latitude.get(finalI));
//                                                                            putdata.child("longitude").setValue(Longitude.get(finalI));
//                                                                            putdata.child("items").setValue(ItemType.get(finalI));
//                                                                            putdata.child("orderid").setValue(String.valueOf(finalI));
//                                                                            putdata.child("number").setValue(PhoneNumber.get(finalI));
//                                                                            putdata.child("name").setValue(name.get(finalI));
//                                                                        }
//
//                                                                    }
//
